    ...
    return (
        <SafeAreaView className="flex-1 pt-6 bg-white">
            <View className="flex-1 bg-gray-100">
                <View className="p-7 border-b border-[#00CCBB] bg-white shadow-xs">
                    <View>
                        <Text className="text-lg font-bold text-center">Basket</Text>
                        {items.length > 1 && (<Text className="text-center text-gray-400">
                            {restaurant.title}
                        </Text>)}
                    </View>
                    <TouchableOpacity
                ...
                {items.length < 1 ? (
                    <>
                        <View className="flex items-center justify-center flex-1">
                            <Text className="text-xl my-2">You don't have items in your basket</Text>
                            <Text> our restaurants to order</Text>

                            <TouchableOpacity className="my-4" onPress={() => navigation.navigate('Home')}>
                                <Text className="text-[#00CCBB] text-lg">Explore now</Text>
                            </TouchableOpacity>
                        </View>
                    </>
                ) : (
